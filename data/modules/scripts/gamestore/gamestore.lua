...
GameStore.Categories = { 
  ...
  -- Cosmetics: Outfits
   {
     ...
     offers = { 
		...
		{
            icons = { "rune_master_male.gif", "rune_master_female.gif" },
            name = "Full Rune Master Outfit",
            price = 500,
            sexId = {female = 1385, male = 1384},
            addon = 3,
            description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Rune Master all your wealth with Rune Master outfit.</i>",
            type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
            home = true,
          },
        {
  ...
  -- Extras Services Category
   {   
     ...
     offers = {
		   {
            icons = { "Journal_Shield.gif" },
            name = "Staminia Refil",
            price = staminarefil_price,
            itemtype = 30183,
            count = 1,
            description = "<i>Staminia</i>\n\n Basta dar use que sua staminia fica full novamente.",
  ...
  -- Items: Outros
   {   
     ...
     offers = { 
		  ...
		  {
            icons = { "Blossom_Bag.gif" },
            name = "Blossom Bag",
            price = 25,
            itemtype = 29080,
            count = 1,
            description = "<i> Devido a grande variedade, backpacks são consideradas itens colecionáveis e também usadas como decoração.</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use it to open it\n{info} always placed on the first position of your Store inbox",
            type = GameStore.OfferTypes.OFFER_TYPE_POUNCH,
          },
		  {
            icons = { "Crystal_Backpack.gif" },
		  ...
		  {
            icons = { "Festive_Backpack.gif" },
            name = "Festive Backpackk",
            price = 25,
            itemtype = 35056,
            count = 1,
            description = "<i> Devido a grande variedade, backpacks são consideradas itens colecionáveis e também usadas como decoração.</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use it to open it\n{info} always placed on the first position of your Store inbox",
		  ...
		  {
            icons = { "Anniversary_Backpack.gif" },
